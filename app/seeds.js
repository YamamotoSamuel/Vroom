...
const carTypes = [
  {
    name:"Sedan",
    description:'Most common car found on the road and is best for daily commutes on paved roads', 
    avgWeight:"Ranges roughly from 2500-4500 lbs in 'curb weight' typically depending on the engine size",
    knownFor:'Simplicity and reliability',
    drivetrain:'Typically FWD, RWD, or AWD'
  },
  {
    body:'Coupe', 
    description:'2 door car typically known to be a manufacturer\'s "sports car" or sport variant', 
    avgWeight:"Ranges roughly from 2500-4500 lbs in 'curb weight' typically depending on the engine size",
  ...
  {
    body:'Van/Minivan', 
    description:'Common car amongst big families and soccer moms all around the globe', 
    avgWeight:"Ranges roughly from 2500-4500 lbs in 'curb weight' typically depending on the engine size",
...
carType.insertMany(carTypes).then(res=>{
